...
PRO cfit_block_point, lambda, data, weights, fit, missing, result, residual, include, const, $
  j, k, l, m, n, o, lam, new_lam, npar, sfit, quiet = quiet, sigma = sigm, $
  make_sigma = make_sigma, error_only = error_only, restart = restart
  ;
...
PRO cfit_block, lambda, data, weights, fit, missing, result, residual, include, const, double = double, $
  ...
  CASE smart OF
    0: BEGIN
      ...
      ;
      FOR o = 0L, dimen[6] - 1 DO BEGIN
        FOR n = 0L, dimen[5] - 1 DO BEGIN
          FOR m = 0L, dimen[4] - 1 DO BEGIN
            FOR l = 0L, dimen[3] - 1 DO BEGIN
              FOR k = 0L, dimen[2] - 1 DO BEGIN
                FOR j = 0L, dimen[1] - 1 DO BEGIN
                  ;
                  ; Only touch results with one or more non-constant parameters
                  ;
                  cfit_block_point, lambda, data, weights, fit, missing, result, residual, include, const, $
                    j, k, l, m, n, o, lam, new_lam, npar, sfit, quiet = quiet, $
                  ...
                  ndone = ndone + 1L
                  pct = (100 * ndone) / ndo
                  cfit_block_progress, pct, lastpct, pctage, pct_slider_id, interrupt_id, halt, quiet
    ...
    1: BEGIN
      ...
      sortix = sort(avdata)
      ; Start with highest S/N ratio
      last_result = !values.f_nan ; Avoids undefined variable warning
      FOR jj = ndo - 1L, 0L, -1L DO BEGIN
        ...
        END
        cfit_block_point, lambda, data, weights, fit, missing, result, residual, include, const, $
          j, k, l, m, n, o, lam, new_lam, npar, sfit, quiet = quiet, restart = restart, $
          make_sigma = make_sigma, sigma = sigma, error_only = error_only
