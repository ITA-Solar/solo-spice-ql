...
;
; Syntax      :	Result = SPICE_FIND_OBSERVATIONS(Date, SolarX, SolarY)
;
...
;			      IF ERRMSG NE '' THEN ...
;
; Calls       :	SPICE_FIND_OBSERVATIONS_EXTRACT, ANYTIM2TAI, CONCAT_DIR, UTC2TAI,
;               TAI2UTC
;
; Common      :	SPICE_FIND_OBSERVATIONS is used internally to store the catalog
...
;                       and MARGIN keywords.
;               Version 4, 04-Nov-2022, WTT, renamed, added COMPILE_OPT line
;
; Contact     :	WTHOMPSON
;-
;
