...
FUNCTION spice_keyword_get_info, header, keyword
  IF stregex(keyword, '^[A-Z0-9_][A-Z0-9_-]* *$') EQ -1 THEN return, !null
...
FUNCTION spice_keyword_info, requested_keywords
...
FUNCTION spice_keyword_info_as_json, requested_keywords
  infos = spice_keyword_info(requested_keywords)
...
IF getenv("USER") EQ "steinhh" THEN BEGIN
  a = spice_keyword_info() ; idl-disable-line unused-var
  b = spice_keyword_info_as_json() ; idl-disable-line unused-var
  print
