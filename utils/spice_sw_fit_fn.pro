FUNCTION spice_sw_fit_fn, x, p, _EXTRA=extra
...
;     Orbiter SPICE instrument in the short wavelength (SW) channel. It
;     is composed of two Gaussians with the same centroid. One Gaussian
;     is narrow with a high amplitude; the other is wide with a low
